...
from typing import Tuple, List, Optional, Text, BinaryIO, Union, Sequence, \
    ByteString, Callable, Any, TypeVar, ParamSpec
...
def YGNodeCalculateLayout(node: YGNodeRef,
...
def YGNodeCanUseCachedMeasurement(
    width_mode: YGMeasureMode, width: float,
    height_mode: YGMeasureMode, height: float,
    last_width_mode: YGMeasureMode, last_width: float,
    last_height_mode: YGMeasureMode, last_height: float,
    last_computed_width: float,
    last_computed_height: float,
    margin_row: float, margin_column: float,
    config: YGConfigRef): ...
...
def YGNodeSetMeasureFunc(node: YGNodeRef, func: Callable[[YGNodeRef, float, YGMeasureMode, float, YGMeasureMode], YGSize]): ...
...
def YGConfigSetLogger(config: YGConfigRef, func: Callable[[YGConfigRef, YGNodeRef, YGLogLevel, str, P], int]): ...
