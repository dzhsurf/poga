...
def YGNodeStyleSetWidth(node: YGNodeRef, width: YGValue): ...
def YGNodeStyleSetWidthPercent(node: YGNodeRef, width: YGValue): ...
def YGNodeStyleSetWidthAuto(node: YGNodeRef, width: YGValue): ...
def YGNodeStyleGetWidth(node: YGNodeRef) -> YGValue: ...
def YGNodeStyleSetHeight(node: YGNodeRef, height: YGValue): ...
def YGNodeStyleSetHeightPercent(node: YGNodeRef, height: YGValue): ...
def YGNodeStyleSetHeightAuto(node: YGNodeRef): ...
def YGNodeStyleGetHeight(node: YGNodeRef) -> YGValue: ...
def YGNodeStyleSetMinWidth(node: YGNodeRef, min_width: YGValue): ...
def YGNodeStyleSetMinWidthPercent(node: YGNodeRef, min_width: YGValue): ...
def YGNodeStyleGetMinWidth(node: YGNodeRef) -> YGValue: ...
def YGNodeStyleSetMinHeight(node: YGNodeRef, min_height: YGValue): ...
def YGNodeStyleSetMinHeightPercent(node: YGNodeRef, min_height: YGValue): ...
def YGNodeStyleGetMinHeight(node: YGNodeRef) -> YGValue: ...
def YGNodeStyleSetMaxWidth(node: YGNodeRef, max_width: YGValue): ...
def YGNodeStyleSetMaxWidthPercent(node: YGNodeRef, max_width: YGValue): ...
def YGNodeStyleGetMaxWidth(node: YGNodeRef) -> YGValue: ...
def YGNodeStyleSetMaxHeight(node: YGNodeRef, max_height: YGValue): ...
def YGNodeStyleSetMaxHeightPercent(node: YGNodeRef, max_height: YGValue): ...
